...
######################
  ...
  Scenario: Verify Anonymous user page access 1
    Given I am not logged in
    Then I check the HTTP response code is "200" for "/"

  @api @regression @smoke @roles
  Scenario: Verify Anonymous user page access 2
    Given I am not logged in
    Then I check the HTTP response code is "200" for "/user/login"

  @api @regression @smoke @roles
  Scenario: Verify Anonymous user page access 3
    Given I am not logged in
    Then I check the HTTP response code is "403" for "/node/add"

  @api @regression @smoke @roles
  Scenario: Verify Anonymous user page access 4
    Given I am not logged in
    Then I check the HTTP response code is "403" for "/admin"

  @api @regression @smoke @roles
  Scenario: Verify Anonymous user page access 5
    Given I am not logged in
...
######################
  ...
  @api @regression @smoke @roles
  Scenario: Verify Admin user page access 1
  ...
  @api @regression @smoke @roles
  Scenario: Verify Admin user page access 2
    Given I am logged in as a user with the administrator role
  ...
  @api @regression @smoke @roles
  Scenario: Verify Admin user page access 3
    Given I am logged in as a user with the administrator role
    When I go to "/node/add"
    Then I should see text matching "Add content"

  @api @regression @smoke @roles
  Scenario: Verify Admin user page access 4
    Given I am logged in as a user with the administrator role
